...
/****************************************************************
    Function: SM2_W
    Description: calculation of wCalls:
...
/****************************************************************
    ...
    Input:  rb // a big number lies in[1,n-1]
            ...
            ZB // Z=hash(ELAN_B||ID of B||a ||b||Gx||Gy||PBx||PBy)klen // byte len of the secret key that A and B wanna share
    Output: K // secret key that A and B wanna share
            RB // RB=[rb]G
            V // V=[h*tB](PA+[x1_]RA),in function SM2_KeyEx_Re_II it as input
            hash // (option) calculates a hash value SB that initiator A might verifies
...
//standard data
    ...
    unsigned char
            ...
            ,0x34,0x28,0xCF,0x60,0x8A,0x5D,0xB8,0xFE,0x5C,0xE0,0x7F,0x15,0x02,0x69,0x40,0xBA,0xE4,0x0E,0x37,0x66,0x29,0xC7,0xAB,0x21,0xE7,0xDB,0x26,0x09,0x22,0x49,0x9D,0xDB,0x11,0x8F,0x07,0xCE,0x
